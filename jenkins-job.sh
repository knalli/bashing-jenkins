...
export BASHING_JENKINS_VERSION="0.0.1"
...
function printHelp(){
	...
	echo ""
	echo "		Examples:"
	echo "			$0 test-project getBuildNumberFor lastBuild"
	echo "			$0 test-project getBuildNumberFor lastPromotedBuild 2"
	echo ""
	echo ""
	echo "	downloadArtifact <buildNumber> <relativeName> [<saveAs>]"
